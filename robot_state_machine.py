	...
	def evaluate_state(self):
		...
		# Otherwise, we just stay in this happy little state :)
			...
			if self.new_turn:
				...
				self.new_turn = False
				print(
					f'{self.heading % 360}/{self.head_diff % 360} ({self.right_speed}, {self.left_speed}) - start a turn')
			elif self.new_turn is False:
				print(
					f'{self.heading % 360}/{self.head_diff % 360} ({self.right_speed}, {self.left_speed}) - still a turn')
