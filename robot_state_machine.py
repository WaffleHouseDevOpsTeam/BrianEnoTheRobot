...
class StateMachine:
    ...
    def evaluate_state(self):
        ...
        # Otherwise, we just stay in this happy little state :)
            ...
            if self.new_turn:
                self.turning_heads = self.heading % 360
                self.new_turn = False
                ...
                #if abs(self.prev_head_diff - self.head_diff)/(self.head_diff+1) <= 0.001:
                #   self.right_speed = 0
                #   self.left_speed = 0
                #   self.new_turn = True
                #   self.state = "FOLLOW_LEFT_WALL"
                if self.head_diff < 45:
                    ...
                    self.left_speed =  self.target_speed
                    self.head_diff = abs((self.heading  % 360) - self.turning_heads % 360)
